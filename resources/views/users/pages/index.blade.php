...
{{-- <div class="container"> --}}
    <div class="hero-area hero-style-two">
        <img alt="image" src="{{ asset('users/assets/images/bg/section-bg2.png') }}" class="radial-bg">
        <img alt="image" src="{{ asset('users/assets/images/bg/banner2-icon1.png') }}" class="banner2-icon1">
        <img alt="image" src="{{ asset('users/assets/images/bg/banner2-icon2.png') }}" class="banner2-icon2">
        <img alt="image" src="{{ asset('users/assets/images/bg/banner2-icon3.png') }}" class="banner2-icon3">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="eg-card category-card2 wow fadeInDown" data-wow-duration="1.5s"
                                    data-wow-delay="0.2s">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/accessories.png') }}" class="category-img">
                                    <div class="content">
                                        <img alt="image" src="{{ asset('users/assets/images/icons/cat-icon2.svg') }}">
                            ...
                            <div class="swiper-slide">
                                <div class="eg-card category-card2 wow fadeInDown" data-wow-duration="1.5s"
                                    data-wow-delay="0.4s">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/cars.png') }}" class="category-img">
                                    <div class="content">
                                        <img alt="image" src="{{ asset('users/assets/images/icons/car-icon.svg') }}">
                            ...
                            <div class="swiper-slide">
                                <div class="eg-card category-card2 wow fadeInDown" data-wow-duration="1.5s"
                                    data-wow-delay="0.6s">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/motobike.png') }}" class="category-img">
                                    <div class="content">
                                        <img alt="image" src="{{ asset('users/assets/images/icons/moto-bike.svg') }}">
                            ...
                            <div class="swiper-slide">
                                <div class="eg-card category-card2 wow fadeInDown" data-wow-duration="1.5s"
                                    data-wow-delay="0.2s">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/fashion.png') }}" class="category-img">
                                    <div class="content">
                                        <img alt="image" src="{{ asset('users/assets/images/icons/cat-icon4.svg') }}">
                            ...
                            <div class="swiper-slide">
                                <div class="eg-card category-card2 wow fadeInDown" data-wow-duration="1.5s"
                                    data-wow-delay="0.4s">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/virtual.png') }}" class="category-img">
                                    <div class="content">
                                        <img alt="image" src="{{ asset('users/assets/images/icons/cat-icon5.svg') }}">
                            ...
                            <div class="swiper-slide">
                                <div class="eg-card category-card2 wow fadeInDown" data-wow-duration="1.5s"
                                    data-wow-delay="0.6s">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/music.png') }}" class="category-img">
                                    <div class="content">
                                        <img alt="image" src="{{ asset('users/assets/images/icons/cat-icon1.svg') }}">
                            ...
                            <div class="swiper-slide">
                                <div class="eg-card category-card2 wow fadeInDown" data-wow-duration="1.5s"
                                    data-wow-delay="1s">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/cards.png') }}" class="category-img">
                                    <div class="content">
                                        <img alt="image" src="{{ asset('users/assets/images/icons/cat-icon3.svg') }}">
    ...
    <div class="live-auction pb-120">
        <img alt="image" src="{{ asset('users/assets/images/bg/section-bg2.png') }}" class="img-fluid section-bg2">
        <div class="container position-relative">
            <img alt="image" src="{{ asset('users/assets/images/bg/dotted2.png') }}" class="dotted3">
            ...
            <div class="row gy-4 d-flex justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-10 ">
                    <div data-wow-duration="1.5s" data-wow-delay="0.2s" class="eg-card auction-card2 wow fadeInDown">
                        <div class="auction-img">
                            <img alt="image" src="{{ asset('users/assets/images/bg/live-auc1.png') }}">
                        ...
                        <div class="auction-content">
                            ...
                            <div class="author-price-area">
                                <div class="author">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/auction-authr1.png') }}"><span class="name">By
                                        Sara
                                        Alexa</span>
                                </div>
                                <p>$3,45</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 ">
                    <div data-wow-duration="1.5s" data-wow-delay="0.4s" class="eg-card auction-card2 wow fadeInDown">
                        <div class="auction-img">
                            <img alt="image" src="{{ asset('users/assets/images/bg/live-auc2.png') }}">
                            <div class="auction-timer">
                        ...
                        <div class="auction-content">
                            ...
                            <div class="author-price-area">
                                <div class="author">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/auction-authr2.png') }}"><span class="name">By
                                        Sara
                                        Alexa</span>
                                </div>
                                <p>$3,45</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 ">
                    <div data-wow-duration="1.5s" data-wow-delay="0.6s" class="eg-card auction-card2 wow fadeInDown">
                        <div class="auction-img">
                            <img alt="image" src="{{ asset('users/assets/images/bg/live-auc3.png') }}">
                            <div class="auction-timer">
                        ...
                        <div class="auction-content">
                            ...
                            <div class="author-price-area">
                                <div class="author">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/auction-authr3.png') }}"><span class="name">By
                                        Sara
                                        Alexa</span>
                                </div>
                                <p>$3,45</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 ">
                    <div data-wow-duration="1.5s" data-wow-delay="0.2s" class="eg-card auction-card2 wow fadeInDown">
                        <div class="auction-img">
                            <img alt="image" src="{{ asset('users/assets/images/bg/live-auc4.png') }}">
                            <div class="auction-timer">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 ">
                    <div data-wow-duration="1.5s" data-wow-delay="0.4s" class="eg-card auction-card2 wow fadeInDown">
                        <div class="auction-img">
                            <img alt="image" src="{{ asset('users/assets/images/bg/live-auc5.png') }}">
                            <div class="auction-timer">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 ">
                    <div data-wow-duration="1.5s" data-wow-delay="0.6s" class="eg-card auction-card2 wow fadeInDown">
                        <div class="auction-img">
                            <img alt="image" src="{{ asset('users/assets/images/bg/live-auc6.png') }}">
                            <div class="auction-timer">
    ...
    <div class="testimonial-section pt-80 pb-80">
        <img alt="image" src="{{ asset('users/assets/images/bg/client-right.png') }}" class="client-right-vector">
        <img alt="image" src="{{ asset('users/assets/images/bg/client-left.png') }}" class="client-left-vector">
        <img alt="image" src="{{ asset('users/assets/images/bg/client-circle4.png') }}" class="client-circle4">
        <img alt="image" src="{{ asset('users/assets/images/bg/client-circle5.png') }}" class="client-circle5">
        <div class="container">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-single style2 hover-border2 wow fadeInDown" data-wow-duration="1.5s"
                                data-wow-delay=".2s">
                                <img alt="image" src="{{ asset('users/assets/images/icons/quote-red.svg') }}" class="quote-icon">
                                <div class="testi-img">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/testi1.png') }}">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-single style2 hover-border2 wow fadeInDown" data-wow-duration="1.5s"
                                ...
                                <img alt="image" src="{{ asset('users/assets/images/icons/quote-red.svg') }}" class="quote-icon">
                                <div class="testi-img">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/testi2.png') }}">
                                </div>
                                <div class="testi-content">
                                    <div class="testi-designation">
                                        <h5>Johan Dou RO</h5>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-single style2 hover-border2 wow fadeInDown" data-wow-duration="1.5s"
                                ...
                                <img alt="image" src="{{ asset('users/assets/images/icons/quote-red.svg') }}" class="quote-icon">
                                <div class="testi-img">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/testi3.png') }}">
                                </div>
                                <div class="testi-content">
                                    <div class="testi-designation">
                                        <h5>Martin Luther</h5>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="eg-card c-feature-card2 wow fadeInDown" data-wow-duration="1.5s"
                                data-wow-delay="0.2s">
                                <div class="auction-img">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/umcoming1.png') }}">
                                    ...
                                    <div class="author-area3">
                                        <div class="author-emo">
                                            <img alt="image" src="{{ asset('users/assets/images/bg/upcoming-author1.png') }}">
                                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="eg-card c-feature-card2 wow fadeInDown" data-wow-duration="1.5s"
                                data-wow-delay="0.4s">
                                <div class="auction-img">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/umcoming2.png') }}">
                                    ...
                                    <div class="author-area3">
                                        <div class="author-emo">
                                            <img alt="image" src="{{ asset('users/assets/images/bg/upcoming-author2.png') }}">
                                        </div>
                                        <div class="author-name">
                                            <span>by @robatfox</span>
                                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="eg-card c-feature-card2 wow fadeInDown" data-wow-duration="1.5s"
                                data-wow-delay="0.6s">
                                <div class="auction-img">
                                    <img alt="image" src="{{ asset('users/assets/images/bg/umcoming3.png') }}">
                                    ...
                                    <div class="author-area3">
                                        <div class="author-emo">
                                            <img alt="image" src="{{ asset('users/assets/images/bg/upcoming-author3.png') }}">
                                        </div>
                                        <div class="author-name">
                                            <span>by @robatfox</span>
                                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="slick-wrapper wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div id="slick1">
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor1.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor2.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor3.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor4.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor5.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor6.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor7.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor8.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor9.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor1.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor3.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor5.png') }}"></div>
                        <div class="slide-item"><img alt="image" src="{{ asset('users/assets/images/bg/sponsor8.png') }}"></div>
            ...
            <div class="row d-flex justify-content-center g-4">
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-10">
                    <div class="single-blog-style2 wow fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <div class="blog-img">
                            ...
                            <img alt="image" src="{{ asset('users/assets/images/blog/recent21.png') }}">
                        </div>
                        <div class="blog-content">
                            ...
                            <div class="blog-meta">
                                <div class="author">
                                    <img alt="image" src="{{ asset('users/assets/images/blog/author1.png') }}">
                                    <a href="blog-details.html" class="author-name">Johan Martin</a>
                                </div>
                                <div class="comment">
                                    <img alt="image" src="{{ asset('users/assets/images/icons/comment-icon.svg') }}">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-10">
                    <div class="single-blog-style2 wow fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.4s">
                        <div class="blog-img">
                            ...
                            <img alt="image" src="{{ asset('users/assets/images/blog/recent22.png') }}">
                        </div>
                        <div class="blog-content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-10">
                    <div class="single-blog-style2 wow fadeInDown" data-wow-duration="1.5s" data-wow-delay=".4s">
                        <div class="blog-img">
                            <a href="#" class="blog-date"><i class="bi bi-calendar-check"></i>May 30, 2022</a>
                            <img alt="image" src="{{ asset('users/assets/images/blog/recent23.png') }}">
                        </div>
                        <div class="blog-content">
            ...
            <div class="row g-4 d-flex justify-content-center">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10 col-10">
                    <div class="counter-single text-center d-flex flex-row hover-border2 wow fadeInDown"
                        ...
                        <div class="counter-icon"> <img alt="image" src="{{ asset('users/assets/images/icons/employee.svg') }}"> </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10 col-10">
                    <div class="counter-single text-center d-flex flex-row hover-border2 wow fadeInDown"
                        ...
                        <div class="counter-icon"> <img alt="image" src="{{ asset('users/assets/images/icons/review.svg') }}"> </div>
                        <div class="coundown d-flex flex-column">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10 col-10">
                    <div class="counter-single text-center d-flex flex-row hover-border2 wow fadeInDown"
                        ...
                        <div class="counter-icon"> <img alt="image" src="{{ asset('users/assets/images/icons/smily.svg') }}"> </div>
                        <div class="coundown d-flex flex-column">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10 col-10">
                    <div class="counter-single text-center d-flex flex-row hover-border2 wow fadeInDown"
                        ...
                        <div class="counter-icon"> <img alt="image" src="{{ asset('users/assets/images/icons/comment.svg') }}"> </div>
                        <div class="coundown d-flex flex-column">
